      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <h2
              data-aos="zoom-in"
              className="text-4xl md:text-5xl font-bold text-[#111827] mb-6 italic"
            >
            ...
            >
              <p>
                ...
                furniture that doesn't just fill your space—it transforms it.
                Every piece in our collection is thoughtfully designed to bring
                beauty, comfort, and functionality to your home.
              </p>
              <p>
                We believe that great furniture should be accessible,
                sustainable, and built to last. That's why we work directly with
                skilled artisans and use only premium materials that stand the
                test of time.
              </p>
            </div>
          ...
          >
            {features.map((feature, index) => {
              ...
              return (
                <span
                  key={index}
                  className="border-0 shadow-xl rounded-lg bg-card"
                >
